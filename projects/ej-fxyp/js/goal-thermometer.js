...
function generateNum(){
	currentAmount = Math.round(Math.random()*(2000-1+1));
}
...
function createGraphics(){
	...
	$("#goal-thermometer").html(
     ...
     $('#therm-body-fore').addClass('tooltipFGImg');
     $('.tip-middle').addClass('tooltipMiddleImg')
	//preload and add the background images
/*	$('<img/>').attr('src', tooltipFGImg).load(function(){
		//$(this).remove();
		//$("#therm-body-fore").css("background-image", "url('images/tickShine.png')");
